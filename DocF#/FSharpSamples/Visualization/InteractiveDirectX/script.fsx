...
//----------------------------------------------------------------------------
// PART 4 - Simulate motion on a surface - Helpers
...
// Display settings: the ball is a point, but how big is the
// mesh we use to render it?
let radiusA = 0.010f 
let radiusB = 0.005f     
...
Async.Spawn 
    (async { for i in 0 .. 6 do 
                do addBall (Ball (Vector3(0.1f,0.1f,0.1f),
                                  Vector3(0.6f,0.5f,0.0f)))
                do! System.Threading.Thread.AsyncSleep(100)  })
